...
MAGURO_BLOBS="asus-flo-1537103-7039b5f9.tgz
              broadcom-flo-1537103-5d0f4b74.tgz
              qcom-flo-1537103-92417c98.tgz"

CSUM_LIST="$PWD/blob-shasums"

cd ../../.. &&
install_blobs new-nexus-7 "$MAGURO_BLOBS" "$CSUM_LIST"
